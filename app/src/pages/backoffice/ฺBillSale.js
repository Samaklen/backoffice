...
function BillSale() {
    ...
    const handlePay = async (item) => {
        try {
            const button = await Swal.fire({
                ...
                text: 'คุณได้ชำระเงิน และตรวจสอบข้อมูลแล้ว',
                icon: 'question',
    ...
    return<BackOffice>
        ...
        <MyModal id='modalInfo' title='รายการการของบิล'>
            <table className="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>รายการ</th>
